...
- AWS AppSync - AWS AppSync is a fully managed GraphQL service. This helps developers connect frontend applications with backend data. offline data synchronization.
