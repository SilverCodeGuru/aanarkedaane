...
- Kendra (search) - document search service
- Rekognition
- Textract - detects and extracts typed handwritten notes

- Lex - conversational interface - bots that talk
- connect - virtual call center
- Personalize - helps build apps with real-time personalized recommendations. same tech as used by amazon.
